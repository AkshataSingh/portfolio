  ...
  return (
    <section className="home-panel" aria-labelledby="hero-title">
      <div className="hero-content">
        ...
        <p className="hero-description">Full Stack Developer &amp; AI Engineer with an <strong>AI Master’s Degree</strong>, <strong>5+ Years</strong> of experience building production web applications and AI-powered systems, and hands-on <strong>Claude Code Experience</strong>.<br className="hero-line-break" /> Researches and builds efficient, <strong>sustainable AI</strong> by compressing and optimising <strong>LLMs</strong> for low-resource, real-time deployment.</p>
        ...
        <div className="hero-email">
          ...
          <a href="https://github.com/AkshataSingh" target="_blank" rel="noopener noreferrer">GitHub</a>
          <a href="https://huggingface.co/Aks44" target="_blank" rel="noopener noreferrer">Hugging Face</a>
        ...
        <ul className="hero-technologies" aria-label="Technologies">
          {['React', 'Node.js', 'Python', 'TypeScript', 'PyTorch', 'Quantization', 'Pruning', 'Distillation', 'Claude', 'OpenAI'].map(technology => <li key={technology}>{technology}</li>)}
        </ul>
        <div className="hero-stats">
          <div className="hero-stat"><span className="hero-stat-icon"><CodeXml aria-hidden="true" /></span><div><strong>5+</strong><span>Years Experience</span></div></div>
